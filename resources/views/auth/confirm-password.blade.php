...
<head>
    ...
    <title>Confirmar Acceso - Carmelo's Agency</title>
...
<body class="auth-page">
    ...
    <div class="auth-card">
        <div class="auth-header">
            <svg style="width:60px; height:60px; color:#ea580c; margin-bottom:10px;" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
            
            <h2 style="margin-top:5px;">Zona Segura</h2>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <div class="form-group" x-data="{ show: false }">
                ...
                <div style="position:relative;">
                    <input :type="show ? 'text' : 'password'" name="password" class="form-input" required autocomplete="current-password" style="padding-right: 40px;">
