...
<head>
    ...
    <title>Nueva Contraseña - Carmelo's Agency</title>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group" x-data="{ show: false }">
                ...
                <div style="position:relative;">
                    <input :type="show ? 'text' : 'password'" name="password" class="form-input" required autocomplete="new-password" style="padding-right: 40px;">
            ...
            <div class="form-group" x-data="{ show: false }">
                ...
                <div style="position:relative;">
                    <input :type="show ? 'text' : 'password'" name="password_confirmation" class="form-input" required autocomplete="new-password" style="padding-right: 40px;">
